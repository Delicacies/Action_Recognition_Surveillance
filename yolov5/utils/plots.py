...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font='Arial.ttf', pil=True):
        ...
        if self.pil:  # use PIL
            ...
            self.font = check_font('yolov5/data/fonts/'+font, size=font_size or max(round(sum(self.im.size) / 2 * 0.025), 12))
        else:  # use cv2
            self.im = im
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            if label:
                ...
                self.draw.text((box[0], box[1] + 1 if outside else box[1] + h + 1), label, fill=txt_color, font=self.font, anchor='ls')  # for PIL>8.0
